...
knitr::include_graphics("~/School/data624/consolidated_report/nnet_tuned_plot.png")
```
<pre>
    size decay
101   17     1
...
```{r echo=FALSE,  out.width = '100%'}
knitr::include_graphics("~/School/data624/consolidated_report/nnet_tuned_variables.png")
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("~/School/data624/consolidated_report/avnnet_tuned_plot.png")
```
<pre>
    size decay   bag
169   15  0.01 FALSE
...
```
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics("~/School/data624/consolidated_report/avnnet_tuned_final_variables.png")
```
